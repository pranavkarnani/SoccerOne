...
season_player_stats_columns = ["chance_of_playing_next_round","chance_of_playing_this_round","code","ep_next",
            "ep_this","event_points","first_name","form","id","news","news_added","now_cost","points_per_game",
            "second_name","selected_by_percent","team_code","total_points","value_form","value_season","web_name",
            "minutes","goals_scored","assists","clean_sheets","goals_conceded","own_goals","penalties_saved",
            "penalties_missed","yellow_cards","red_cards","saves","bonus","influence","creativity","threat",
            "ict_index","influence_rank_type","creativity_rank_type","threat_rank_type","ict_index_rank",
            "ict_index_rank_type","penalties_order","penalties_text"]
